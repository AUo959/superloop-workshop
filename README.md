...
> **Status:** Foundational research environment. Nothing in this repository should be treated as production-ready or canonically validated unless it has passed the promotion requirements in [GOVERNANCE.md](GOVERNANCE.md).
...
| Path | Function |
| --- | --- |
| [`docs/whitepapers/`](docs/whitepapers/) | Foundational research papers and preserved source artifacts |
| [`docs/bridges/`](docs/bridges/) | Controlled synthesis between distinct research lines |
| [`specs/`](specs/) | Testable contracts and formalizing specifications |
| [`registry/`](registry/) | Concept identity, status, provenance, and relationship tracking |
| [`experiments/`](experiments/) | Hypotheses, protocols, results, and falsification records |
| [`src/`](src/) | Future reference implementations and simulation code |
| [`tests/`](tests/) | Invariants, regression tests, and adversarial validation |
